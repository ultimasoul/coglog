...
Read `${CLAUDE_SKILL_DIR}/../loader-coglog/SKILL.md` for the full CogLog instruction set, then execute the `/cog-rebuild` instructions (Section ## 11). When the instructions reference `COGLOG_SCRIPTS_DIR`, use the scripts directory path above.
